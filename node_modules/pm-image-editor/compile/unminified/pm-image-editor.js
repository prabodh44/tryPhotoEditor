...
(function () {
    ...
    factory('DraggableFactory', function() {
      ...
      DraggableFactory.prototype.dragStart = function(event, element, parentElement) {
        if(event.type === "touchstart") {
            ...
            .setOriginalMousePosition(event.changedTouches[0].screenY, event.changedTouches[0].screenX)
            .setSize(element)
    ...
    controller('DraggableController', function($scope, $document, $rootScope, DraggableFactory) {
      ...
      $scope.draggableMousedown = function(event) {
        ...
        $document.on('mousemove touchmove', $scope.draggableMousemove);
        $document.on('mouseup touchend', $scope.draggableMouseup);
      };
      ...
      $scope.draggableMouseup = function(event) {
        ...
        $document.unbind('mousemove touchmove', $scope.draggableMousemove);
        $document.unbind('mouseup touchend', $scope.draggableMouseup);
...
(function () {
    ...
    controller('ResizableController', function($scope, $document, $rootScope, ResizableFactory) {
      ...
      $scope.resizableHandleMousedown = function(event) {
        ...
        $document.on('mousemove touchmove', $scope.resizableMousemove);
        $document.on('mouseup touchend', $scope.resizableMouseup);
      };
      ...
      $scope.resizableMouseup = function(event) {
        ...
        $document.unbind('mousemove touchstart', $scope.resizableMousemove);
        $document.unbind('mouseup touchend', $scope.resizableMouseup);
